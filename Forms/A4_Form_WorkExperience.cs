...
{
    public partial class A4_Form_WorkExperience : Form
    {
...
• Use Action Verbs: Start each bullet point with a strong action verb to convey your contributions clearly (e.g., led, developed, implemented).";
            ...
            this.Load += A4_Form_WorkExperience_Load;
            this.Shown += A4_Form_WorkExperience_Shown;
            this.FormClosing += A4_Form_WorkExperience_FormClosing;
        }

        public A4_Form_WorkExperience(Size parentSize)
        {
            InitializeComponent();
...
• Use Action Verbs: Start each bullet point with a strong action verb to convey your contributions clearly (e.g., led, developed, implemented).";
        ...
        private void A4_Form_WorkExperience_Load(object sender, EventArgs e)
        {
        ...
        private void A4_Form_WorkExperience_Shown(object sender, EventArgs e)
        {
            if (!IsInDesignMode())
            {
        ...
        {
            Properties.Settings.Default.A4_WorkExp_Position1 = textBox_Position1.Text;
            Properties.Settings.Default.A4_WorkExp_Company1 = textBox_Company1.Text;
            Properties.Settings.Default.A4_WorkExp_Location1 = textBox_Location1.Text;
            Properties.Settings.Default.A4_WorkExp_Year1 = textBox_Year1.Text;
            Properties.Settings.Default.A4_WorkExp_Experience1 = textBox_Exp1.Text;

            Properties.Settings.Default.A4_WorkExp_Position2 = textBox_Position2.Text;
            Properties.Settings.Default.A4_WorkExp_Company2 = textBox_Company2.Text;
            Properties.Settings.Default.A4_WorkExp_Location2 = textBox_Location2.Text;
            Properties.Settings.Default.A4_WorkExp_Year2 = textBox_Year2.Text;
            Properties.Settings.Default.A4_WorkExp_Experience2 = textBox_Exp2.Text;

            Properties.Settings.Default.Save();
            unsavedChanges = false;
        }

        // Loads saved user settings into the textboxes.
        private void LoadUserSettings()
        {
            textBox_Position1.Text = Properties.Settings.Default.A4_WorkExp_Position1;
            textBox_Company1.Text = Properties.Settings.Default.A4_WorkExp_Company1;
            textBox_Location1.Text = Properties.Settings.Default.A4_WorkExp_Location1;
            textBox_Year1.Text = Properties.Settings.Default.A4_WorkExp_Year1;
            textBox_Exp1.Text = Properties.Settings.Default.A4_WorkExp_Experience1;

            textBox_Position2.Text = Properties.Settings.Default.A4_WorkExp_Position2;
            textBox_Company2.Text = Properties.Settings.Default.A4_WorkExp_Company2;
            textBox_Location2.Text = Properties.Settings.Default.A4_WorkExp_Location2;
            textBox_Year2.Text = Properties.Settings.Default.A4_WorkExp_Year2;
            textBox_Exp2.Text = Properties.Settings.Default.A4_WorkExp_Experience2;
        }

        private void A4_Form_WorkExperience_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (unsavedChanges)
                AutosaveUserSettings();
        }
        ...
        // Navigation: Go to the Resume Template.
        private void button_GoTo_Click(object sender, EventArgs e)
        {
            ...
            string[] userData = new string[]
                ...
                Properties.Settings.Default.A4ProInfo_ProSum,
                Properties.Settings.Default.A4ProInfo_Cert_1,
                Properties.Settings.Default.A4ProInfo_Major_1,
                Properties.Settings.Default.A4ProInfo_College_1,
                Properties.Settings.Default.A4ProInfo_Year_1,
                Properties.Settings.Default.A4ProInfo_Cert_2,
                Properties.Settings.Default.A4ProInfo_Major_2,
                Properties.Settings.Default.A4ProInfo_College_2,
                Properties.Settings.Default.A4ProInfo_Year_2,
                // Data from Skills (indicates 15 - 32)
                Properties.Settings.Default.A4Skills_ProSkill_1,
                Properties.Settings.Default.A4Skills_ProSkill_2,
                Properties.Settings.Default.A4Skills_ProSkill_3,
                Properties.Settings.Default.A4Skills_ProSkill_4,
                Properties.Settings.Default.A4Skills_ProSkill_5,
                Properties.Settings.Default.A4Skills_ProSkill_6,
                Properties.Settings.Default.A4Skills_ProSkill_7,
                Properties.Settings.Default.A4Skills_ProSkill_8,
                Properties.Settings.Default.A4Skills_ProSkill_9,
                Properties.Settings.Default.A4Skills_TechSkill_1,
                Properties.Settings.Default.A4Skills_TechSkill_2,
                Properties.Settings.Default.A4Skills_TechSkill_3,
                Properties.Settings.Default.A4Skills_TechSkill_4,
                Properties.Settings.Default.A4Skills_TechSkill_5,
                Properties.Settings.Default.A4Skills_TechSkill_6,
                Properties.Settings.Default.A4Skills_TechSkill_7,
                Properties.Settings.Default.A4Skills_TechSkill_8,
                Properties.Settings.Default.A4Skills_TechSkill_9,
                // Data from WorkExperience (indicates 33 - 42)
                Properties.Settings.Default.A4_WorkExp_Position1,
                Properties.Settings.Default.A4_WorkExp_Company1,
                Properties.Settings.Default.A4_WorkExp_Location1,
                Properties.Settings.Default.A4_WorkExp_Year1,
                Properties.Settings.Default.A4_WorkExp_Experience1,
                Properties.Settings.Default.A4_WorkExp_Position2,
                Properties.Settings.Default.A4_WorkExp_Company2,
                Properties.Settings.Default.A4_WorkExp_Location2,
                Properties.Settings.Default.A4_WorkExp_Year2,
                Properties.Settings.Default.A4_WorkExp_Experience2,
            };

            // 3) Launch the preview and close this form
            var a4 = new A4_Resume(userData) { Size = this.Size };
            a4.Show();
            this.Close();
        }

        // Navigation: Go back to A4_Form_Skills.
        private void button_Back_Click(object sender, EventArgs e)
        {
            // Flush any edits into Settings first
            if (unsavedChanges)
                AutosaveUserSettings();
            Properties.Settings.Default.Save();

            // Open the previous screen and close this one
            var a4Skills = new A4_Form_Skills { Size = this.Size };
            a4Skills.Show();
            this.Close();
        }

        // Save button event handler for Work Experience.
        private void button_Save_A4Work_Click_1(object sender, EventArgs e)
        {
            AutosaveUserSettings();
