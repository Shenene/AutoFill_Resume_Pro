...
{
    public partial class USLetter_Form_ProfessionalInfo : Form
    {
        ...
        public USLetter_Form_ProfessionalInfo()
        {
            this.AutoScaleMode = AutoScaleMode.None;
            this.Font = new Font(this.Font.FontFamily, 10F, FontStyle.Regular, GraphicsUnit.Point);
            InitializeComponent();

            // Since textBox1 is now a WatermarkRichTextBox, set its WatermarkText.
            textBox_ProSum.WatermarkText =
                "Use this section to make a strong first impression by summarizing your key skills, experiences, and career highlights. " +
                "Focus on what makes you an exceptional candidate for a wide range of roles, showcasing your versatility and ability to adapt to different industries. " +
                "Highlight your core competencies and notable achievements to capture the reader's attention and set the tone for the rest of your resume.";
            ...
            this.Load += USLetter_Form_ProfessionalInfo_Load;
            this.Shown += USLetter_Form_ProfessionalInfo_Shown;
            this.FormClosing += USLetter_Form_ProfessionalInfo_FormClosing;
        }

        public USLetter_Form_ProfessionalInfo(Size parentSize)
        {
            InitializeComponent();
            textBox_ProSum.WatermarkText =
                "Use this section to make a strong first impression by summarizing your key skills, experiences, and career highlights. " +
        ...
        private void USLetter_Form_ProfessionalInfo_Load(object sender, EventArgs e)
        {
        ...
        /// </summary>
        private void USLetter_Form_ProfessionalInfo_Shown(object sender, EventArgs e)
        {
            if (!IsInDesignMode())
            {
                // Configure single-line text boxes with watermark placeholders.
        ...
        // Saves the user settings for US Letter Professional Info.
        private void AutosaveUserSettings()
        {
            Properties.Settings.Default.USProInfo_ProSum = textBox_ProSum.Text;
            Properties.Settings.Default.USProInfo_Cert_1 = textBox2.Text;
            Properties.Settings.Default.USProInfo_Major_1 = textBox3.Text;
            Properties.Settings.Default.USProInfo_College_1 = textBox4.Text;
            Properties.Settings.Default.USProInfo_Year_1 = textBox5.Text;
            Properties.Settings.Default.USProInfo_Cert_2 = textBox6.Text;
            Properties.Settings.Default.USProInfo_Major_2 = textBox7.Text;
            Properties.Settings.Default.USProInfo_College_2 = textBox8.Text;
            Properties.Settings.Default.USProInfo_Year_2 = textBox9.Text;
            Properties.Settings.Default.Save();
            unsavedChanges = false;
        }

        // Loads saved settings back into the textboxes.
        private void LoadUserSettings()
        {
            textBox_ProSum.Text = Properties.Settings.Default.USProInfo_ProSum;
            textBox2.Text = Properties.Settings.Default.USProInfo_Cert_1;
            textBox3.Text = Properties.Settings.Default.USProInfo_Major_1;
            textBox4.Text = Properties.Settings.Default.USProInfo_College_1;
            textBox5.Text = Properties.Settings.Default.USProInfo_Year_1;
            textBox6.Text = Properties.Settings.Default.USProInfo_Cert_2;
            textBox7.Text = Properties.Settings.Default.USProInfo_Major_2;
            textBox8.Text = Properties.Settings.Default.USProInfo_College_2;
            textBox9.Text = Properties.Settings.Default.USProInfo_Year_2;
        }

        private void USLetter_Form_ProfessionalInfo_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        // Navigation: Go to USLetter_Form_Skills.
        ...
        private void button_Back_Click(object sender, EventArgs e)
        {
            ...
            var resumeSizeForm = new Resume_Size
            {
                Size = this.Size
            };
            resumeSizeForm.Show();
        ...
        private void button_Save_USProInfo_Click_1(object sender, EventArgs e)
        {
            AutosaveUserSettings();
        ...
        private void button_SpellCheck_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TextBoxBase[] textBoxes = { textBox_ProSum, textBox2, textBox3, textBox4, textBox6, textBox7, textBox8 };
