...
// using AutoFill_Resume_Pro.Helpers;  // No longer needed with the custom control
...
{
    public partial class USLetter_Form_Skills : Form
    {
        ...
        public USLetter_Form_Skills()
        {
            ...
            this.Load += USLetter_Form_Skills_Load;
            this.Shown += USLetter_Form_Skills_Shown;
            this.FormClosing += USLetter_Form_Skills_FormClosing;
        }

        public USLetter_Form_Skills(Size parentSize)
        {
            InitializeComponent();
        ...
        private void USLetter_Form_Skills_Load(object sender, EventArgs e)
        {
        ...
        private void USLetter_Form_Skills_Shown(object sender, EventArgs e)
        {
            if (!IsInDesignMode())
            {
                // Set watermark placeholders for Professional Skills textboxes using custom control properties.
                ...
                // Set watermark placeholders for Technical Skills textboxes using custom control properties.
        ...
        {
            // Professional Skills
            Properties.Settings.Default.USSkills_ProSkill_1 = textBoxPS_1.Text;
            Properties.Settings.Default.USSkills_ProSkill_2 = textBoxPS_2.Text;
            Properties.Settings.Default.USSkills_ProSkill_3 = textBoxPS_3.Text;
            Properties.Settings.Default.USSkills_ProSkill_4 = textBoxPS_4.Text;
            Properties.Settings.Default.USSkills_ProSkill_5 = textBoxPS_5.Text;
            Properties.Settings.Default.USSkills_ProSkill_6 = textBoxPS_6.Text;
            Properties.Settings.Default.USSkills_ProSkill_7 = textBoxPS_7.Text;
            Properties.Settings.Default.USSkills_ProSkill_8 = textBoxPS_8.Text;
            Properties.Settings.Default.USSkills_ProSkill_9 = textBoxPS_9.Text;           

            // Technical Skills
            Properties.Settings.Default.USSkills_TechSkill_1 = textBoxTS_1.Text;
            Properties.Settings.Default.USSkills_TechSkill_2 = textBoxTS_2.Text;
            Properties.Settings.Default.USSkills_TechSkill_3 = textBoxTS_3.Text;
            Properties.Settings.Default.USSkills_TechSkill_4 = textBoxTS_4.Text;
            Properties.Settings.Default.USSkills_TechSkill_5 = textBoxTS_5.Text;
            Properties.Settings.Default.USSkills_TechSkill_6 = textBoxTS_6.Text;
            Properties.Settings.Default.USSkills_TechSkill_7 = textBoxTS_7.Text;
            Properties.Settings.Default.USSkills_TechSkill_8 = textBoxTS_8.Text;
            Properties.Settings.Default.USSkills_TechSkill_9 = textBoxTS_9.Text;
        ...
        {
            // Professional Skills
            textBoxPS_1.Text = Properties.Settings.Default.USSkills_ProSkill_1;
            textBoxPS_2.Text = Properties.Settings.Default["USSkills_ProSkill_2"].ToString();
            textBoxPS_3.Text = Properties.Settings.Default["USSkills_ProSkill_3"].ToString();
            textBoxPS_4.Text = Properties.Settings.Default["USSkills_ProSkill_4"].ToString();
            textBoxPS_5.Text = Properties.Settings.Default["USSkills_ProSkill_5"].ToString();
            textBoxPS_6.Text = Properties.Settings.Default["USSkills_ProSkill_6"].ToString();
            textBoxPS_7.Text = Properties.Settings.Default["USSkills_ProSkill_7"].ToString();
            textBoxPS_8.Text = Properties.Settings.Default["USSkills_ProSkill_8"].ToString();
            textBoxPS_9.Text = Properties.Settings.Default.USSkills_ProSkill_9;            

            // Technical Skills
            textBoxTS_1.Text = Properties.Settings.Default.USSkills_TechSkill_1;
            textBoxTS_2.Text = Properties.Settings.Default.USSkills_TechSkill_2;
            textBoxTS_3.Text = Properties.Settings.Default.USSkills_TechSkill_3;
            textBoxTS_4.Text = Properties.Settings.Default.USSkills_TechSkill_4;
            textBoxTS_5.Text = Properties.Settings.Default.USSkills_TechSkill_5;
            textBoxTS_6.Text = Properties.Settings.Default.USSkills_TechSkill_6;
            textBoxTS_7.Text = Properties.Settings.Default.USSkills_TechSkill_7;
            textBoxTS_8.Text = Properties.Settings.Default.USSkills_TechSkill_8;
            textBoxTS_9.Text = Properties.Settings.Default.USSkills_TechSkill_9;           
        }

        private void USLetter_Form_Skills_FormClosing(object sender, FormClosingEventArgs e)
        {
            // Autosave unsaved changes when closing.
            if (unsavedChanges)
            {
                AutosaveUserSettings();
            }
        ...
        // Navigation: Go to USLetter_Form_WorkExperience.
        private void button_Next_Click(object sender, EventArgs e)
        {
            // 1) Flush any unsaved edits into Settings
            if (unsavedChanges)
                AutosaveUserSettings();
            // 2) Persist everything you just autosaved
            Properties.Settings.Default.Save();

            // 3) Open the next form
            var workExpForm = new USLetter_Form_WorkExperience
            {
                Size = this.Size
            };
            workExpForm.Show();

            // 4) Close the outgoing form
            this.Close();
        }


        // Navigation: Go back to USLetter_Form_ProfessionalInfo.
        private void button_Back_Click(object sender, EventArgs e)
        {
            ...
            // 3) Open the previous form
            var profInfoForm = new USLetter_Form_ProfessionalInfo
            {
                Size = this.Size
            };
            profInfoForm.Show();
        ...
        private void button_Save_USSkills_Click_1(object sender, EventArgs e)
        {
            AutosaveUserSettings();
