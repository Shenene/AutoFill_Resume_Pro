...
{
    public partial class USLetter_Reference_Info : Form
    {
        ...
        public USLetter_Reference_Info()
        {
            ...
            this.Load += USLetter_Reference_Info_Load;
            this.Shown += USLetter_Reference_Info_Shown;
            this.FormClosing += USLetter_Reference_Info_FormClosing;
        }

        public USLetter_Reference_Info(Size parentSize)
        {
            InitializeComponent();
        ...
        private void USLetter_Reference_Info_Load(object sender, EventArgs e)
        {
        ...
        private void USLetter_Reference_Info_Shown(object sender, EventArgs e)
        {
            if (!IsInDesignMode())
            {
        ...
        // Saves the reference information into user settings.
        private void AutosaveUserSettings()
        {
            // Reference 1
            Properties.Settings.Default.US_Ref_RefName1 = textBox_RN1.Text;
            Properties.Settings.Default.US_Ref_PositionT1 = textBox_PT1.Text;
            Properties.Settings.Default.US_Ref_Org1 = textBox_ORG1.Text;
            Properties.Settings.Default.US_Ref_Phone1 = textBox_PH1.Text;
            Properties.Settings.Default.US_Ref_Email1 = textBox_EM1.Text;
            // Reference 2
            Properties.Settings.Default.US_Ref_RefName2 = textBox_RN2.Text;
            Properties.Settings.Default.US_Ref_PositionT2 = textBox_PT2.Text;
            Properties.Settings.Default.US_Ref_Org2 = textBox_ORG2.Text;
            Properties.Settings.Default.US_Ref_Phone2 = textBox_PH2.Text;
            Properties.Settings.Default.US_Ref_Email2 = textBox_EM2.Text;
            // Reference 3
            Properties.Settings.Default.US_Ref_RefName3 = textBox_RN3.Text;
            Properties.Settings.Default.US_Ref_PositionT3 = textBox_PT3.Text;
            Properties.Settings.Default.US_Ref_Org3 = textBox_ORG3.Text;
            Properties.Settings.Default.US_Ref_Phone3 = textBox_PH3.Text;
            Properties.Settings.Default.US_Ref_Email3 = textBox_EM3.Text;
            // Reference 4
            Properties.Settings.Default.US_Ref_RefName4 = textBox_RN4.Text;
            Properties.Settings.Default.US_Ref_PositionT4 = textBox_PT4.Text;
            Properties.Settings.Default.US_Ref_Org4 = textBox_ORG4.Text;
            Properties.Settings.Default.US_Ref_Phone4 = textBox_PH4.Text;
            Properties.Settings.Default.US_Ref_Email4 = textBox_EM4.Text;
            // Reference 5
            Properties.Settings.Default.US_Ref_RefName5 = textBox_RN5.Text;
            Properties.Settings.Default.US_Ref_PositionT5 = textBox_PT5.Text;
            Properties.Settings.Default.US_Ref_Org5 = textBox_ORG5.Text;
            Properties.Settings.Default.US_Ref_Phone5 = textBox_PH5.Text;
            Properties.Settings.Default.US_Ref_Email5 = textBox_EM5.Text;

            Properties.Settings.Default.Save();
            unsavedChanges = false;
        }

        // Loads the saved reference information into the textboxes.
        private void LoadUserSettings()
        {
            // Reference 1
            textBox_RN1.Text = Properties.Settings.Default.US_Ref_RefName1;
            textBox_PT1.Text = Properties.Settings.Default.US_Ref_PositionT1;
            textBox_ORG1.Text = Properties.Settings.Default.US_Ref_Org1;
            textBox_PH1.Text = Properties.Settings.Default.US_Ref_Phone1;
            textBox_EM1.Text = Properties.Settings.Default.US_Ref_Email1;
            // Reference 2
            textBox_RN2.Text = Properties.Settings.Default.US_Ref_RefName2;
            textBox_PT2.Text = Properties.Settings.Default.US_Ref_PositionT2;
            textBox_ORG2.Text = Properties.Settings.Default.US_Ref_Org2;
            textBox_PH2.Text = Properties.Settings.Default.US_Ref_Phone2;
            textBox_EM2.Text = Properties.Settings.Default.US_Ref_Email2;
            // Reference 3
            textBox_RN3.Text = Properties.Settings.Default.US_Ref_RefName3;
            textBox_PT3.Text = Properties.Settings.Default.US_Ref_PositionT3;
            textBox_ORG3.Text = Properties.Settings.Default.US_Ref_Org3;
            textBox_PH3.Text = Properties.Settings.Default.US_Ref_Phone3;
            textBox_EM3.Text = Properties.Settings.Default.US_Ref_Email3;
            // Reference 4
            textBox_RN4.Text = Properties.Settings.Default.US_Ref_RefName4;
            textBox_PT4.Text = Properties.Settings.Default.US_Ref_PositionT4;
            textBox_ORG4.Text = Properties.Settings.Default.US_Ref_Org4;
            textBox_PH4.Text = Properties.Settings.Default.US_Ref_Phone4;
            textBox_EM4.Text = Properties.Settings.Default.US_Ref_Email4;
            // Reference 5
            textBox_RN5.Text = Properties.Settings.Default.US_Ref_RefName5;
            textBox_PT5.Text = Properties.Settings.Default.US_Ref_PositionT5;
            textBox_ORG5.Text = Properties.Settings.Default.US_Ref_Org5;
            textBox_PH5.Text = Properties.Settings.Default.US_Ref_Phone5;
            textBox_EM5.Text = Properties.Settings.Default.US_Ref_Email5;
        }

        private void USLetter_Reference_Info_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (unsavedChanges)
                AutosaveUserSettings();
        }
        ...
        private void button_GoTo_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.Form1_FullName,
                ...
                Properties.Settings.Default.US_Ref_RefName1,
                Properties.Settings.Default.US_Ref_PositionT1,
                Properties.Settings.Default.US_Ref_Org1,
                Properties.Settings.Default.US_Ref_Phone1,
                Properties.Settings.Default.US_Ref_Email1,
                Properties.Settings.Default.US_Ref_RefName2,
                Properties.Settings.Default.US_Ref_PositionT2,
                Properties.Settings.Default.US_Ref_Org2,
                Properties.Settings.Default.US_Ref_Phone2,
                Properties.Settings.Default.US_Ref_Email2,
                Properties.Settings.Default.US_Ref_RefName3,
                Properties.Settings.Default.US_Ref_PositionT3,
                Properties.Settings.Default.US_Ref_Org3,
                Properties.Settings.Default.US_Ref_Phone3,
                Properties.Settings.Default.US_Ref_Email3,
                Properties.Settings.Default.US_Ref_RefName4,
                Properties.Settings.Default.US_Ref_PositionT4,
                Properties.Settings.Default.US_Ref_Org4,
                Properties.Settings.Default.US_Ref_Phone4,
                Properties.Settings.Default.US_Ref_Email4,
                Properties.Settings.Default.US_Ref_RefName5,
                Properties.Settings.Default.US_Ref_PositionT5,
                Properties.Settings.Default.US_Ref_Org5,
                Properties.Settings.Default.US_Ref_Phone5,
                Properties.Settings.Default.US_Ref_Email5,
        };
            var usReferences = new USLetter_References(userData)
            {
                Size = this.Size
            };
            usReferences.Show();
        ...
        private void button_Save_USRef_Click_1(object sender, EventArgs e)
        {
            AutosaveUserSettings();
