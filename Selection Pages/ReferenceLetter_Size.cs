...
{
    public partial class ReferenceLetter_Size: Form
    {
        public ReferenceLetter_Size()
        {
        ...
        public ReferenceLetter_Size(Size parentSize)
        {
            InitializeComponent();
        ...
        {
            var us = new USLetter_Reference_Info
            {
                Size = this.Size
            };
            us.Show();
