...
{
    public partial class A4_CoverLetter : Form
    {
        ...
        public A4_CoverLetter(string[] userData)
        {
            ...
            // Fixed A4 panel size and high‑quality rendering
            panelA4.Size = new Size(fixedWidth, fixedHeight);
            this.DoubleBuffered = true;
            this.FormBorderStyle = FormBorderStyle.Sizable;
            this.MaximizeBox = true;
            this.Resize += A4_CoverLetter_Resize;

            // 2) Do everything else on Load:
            this.Load += (s, e) =>
            {
                // a) apply saved fonts/colors/icons
                LoadUserSettings();

                // b) override with the passed-in data (must be ≥ 14 items)
        ...
        printDocument = new PrintDocument();
            ...
            autosaveTimer.Start();
            this.FormClosing += A4_CoverLetter_FormClosing;         
        }        
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var a4Info = new A4_CoverLetter_Info();
            a4Info.Size = this.Size;
            a4Info.Show();
            this.Close();
        }
        ...
        // Remove the duplicate method definition for A4_CoverLetter_Resize
        private void A4_CoverLetter_Resize(object sender, EventArgs e)
        {
            panelA4.Size = new Size(fixedWidth, fixedHeight);
        ...
        private void AutosaveUserSettings()
        {
            ...
            Properties.Settings.Default.A4_CoverLetter_Name = label_Name.Text;
            Properties.Settings.Default.A4_CoverLetter_PositionTitle = label_PositionTitle.Text;
            Properties.Settings.Default.A4_CoverLetter_Phone = label_Phone.Text;
            Properties.Settings.Default.A4_CoverLetter_Email = label_Email.Text;
            Properties.Settings.Default.A4_CoverLetter_Location = label_Location.Text;
            Properties.Settings.Default.A4_CoverLetter_LinkedIn = label_LinkedIn.Text;

            // Save cover letter–specific settings.
            Properties.Settings.Default.A4_CoverLetter_Date = label_Date.Text;
            Properties.Settings.Default.A4_CoverLetter_HiringMgr = label_HMgrsFName.Text;
            Properties.Settings.Default.A4_CoverLetter_Company = label_CompanyName.Text;
            Properties.Settings.Default.A4_CoverLetter_CompAddress = label_CompanyAddress.Text;
            Properties.Settings.Default.A4_CoverLetter_City = label_City.Text;
            Properties.Settings.Default.A4_CoverLetter_HMN = label_HMgrsN.Text;
            Properties.Settings.Default.A4_CoverLetter_Body = label_CL_Body.Text;
            Properties.Settings.Default.A4_CoverLetter_YFN = label_YourName.Text;

            // Save font settings.
            Properties.Settings.Default.A4_CoverLetter_FontName_Name = comboBox_FontName_Name.SelectedItem?.ToString() ?? "Microsoft Sans Serif";
            Properties.Settings.Default.A4_CoverLetter_FontSize_Name = (decimal)numericUpDown_Size_Name.Value;
            Properties.Settings.Default.A4_CoverLetter_Color_Name = button_Color_Name.BackColor.ToArgb();

            Properties.Settings.Default.A4_CoverLetter_FontName_PT = comboBox_FontName_PT.SelectedItem?.ToString() ?? "Microsoft Sans Serif";
            Properties.Settings.Default.A4_CoverLetter_FontSize_PT = (decimal)numericUpDown_Size_PT.Value;
            Properties.Settings.Default.A4_CoverLetter_Color_PT = button_Color_PT.BackColor.ToArgb();

            Properties.Settings.Default.A4_CoverLetter_FontName_Body = comboBox_FontName_B.SelectedItem?.ToString() ?? "Microsoft Sans Serif";
            Properties.Settings.Default.A4_CoverLetter_FontSize_Body = (decimal)numericUpDown_Size_B.Value;
            Properties.Settings.Default.A4_CoverLetter_Color_Body = button_Color_B.BackColor.ToArgb();

            Properties.Settings.Default.A4_CoverLetter_FontName_Signature = comboBox_FontName_S.SelectedItem?.ToString() ?? "Monotype Corsiva";
            Properties.Settings.Default.A4_CoverLetter_FontSize_Signature = (decimal)numericUpDown_Size_S.Value;
            Properties.Settings.Default.A4_CoverLetter_Color_Signature = button_Color_S.BackColor.ToArgb();

            // Save icon file paths and icon color.
            Properties.Settings.Default.A4_CoverLetter_Icon1Path = pictureBox_Icon1.Tag as string ?? "";
            Properties.Settings.Default.A4_CoverLetter_Icon2Path = pictureBox_Icon2.Tag as string ?? "";
            Properties.Settings.Default.A4_CoverLetter_Icon3Path = pictureBox_Icon3.Tag as string ?? "";
            Properties.Settings.Default.A4_CoverLetter_Icon4Path = pictureBox_Icon4.Tag as string ?? "";
            Properties.Settings.Default.A4_CoverLetter_IconColor = button_IconColor.BackColor.ToArgb();

            // Persist each icon’s Visible state:
            Properties.Settings.Default.A4_CoverLetter_Icon1Visible = pictureBox_Icon1.Visible;
            Properties.Settings.Default.A4_CoverLetter_Icon2Visible = pictureBox_Icon2.Visible;
            Properties.Settings.Default.A4_CoverLetter_Icon3Visible = pictureBox_Icon3.Visible;
            Properties.Settings.Default.A4_CoverLetter_Icon4Visible = pictureBox_Icon4.Visible;
        ...
        {
            label_Name.Text = Properties.Settings.Default.A4_CoverLetter_Name;
            label_PositionTitle.Text = Properties.Settings.Default.A4_CoverLetter_PositionTitle;
            label_Phone.Text = Properties.Settings.Default.A4_CoverLetter_Phone;
            label_Email.Text = Properties.Settings.Default.A4_CoverLetter_Email;
            label_Location.Text = Properties.Settings.Default.A4_CoverLetter_Location;
            label_LinkedIn.Text = Properties.Settings.Default.A4_CoverLetter_LinkedIn;
            label_Date.Text = Properties.Settings.Default.A4_CoverLetter_Date;
            label_HMgrsFName.Text = Properties.Settings.Default.A4_CoverLetter_HiringMgr;
            label_CompanyName.Text = Properties.Settings.Default.A4_CoverLetter_Company;
            label_CompanyAddress.Text = Properties.Settings.Default.A4_CoverLetter_CompAddress;
            label_City.Text = Properties.Settings.Default.A4_CoverLetter_City;
            label_HMgrsN.Text = Properties.Settings.Default.A4_CoverLetter_HMN;
            label_CL_Body.Text = Properties.Settings.Default.A4_CoverLetter_Body;
            label_YourName.Text = Properties.Settings.Default.A4_CoverLetter_YFN;

            // Name
            string savedFontName = Properties.Settings.Default.A4_CoverLetter_FontName_Name;
            comboBox_FontName_Name.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Microsoft Sans Serif";
            numericUpDown_Size_Name.Value = Properties.Settings.Default.A4_CoverLetter_FontSize_Name > 0
                ? Properties.Settings.Default.A4_CoverLetter_FontSize_Name : 25;
            int colorVal = Properties.Settings.Default.A4_CoverLetter_Color_Name;
            button_Color_Name.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Position Title
            savedFontName = Properties.Settings.Default.A4_CoverLetter_FontName_PT;
            comboBox_FontName_PT.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Microsoft Sans Serif";
            numericUpDown_Size_PT.Value = Properties.Settings.Default.A4_CoverLetter_FontSize_PT > 0
                ? Properties.Settings.Default.A4_CoverLetter_FontSize_PT : 12;
            colorVal = Properties.Settings.Default.A4_CoverLetter_Color_PT;
            button_Color_PT.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Body
            savedFontName = Properties.Settings.Default.A4_CoverLetter_FontName_Body;
            comboBox_FontName_B.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Microsoft Sans Serif";
            numericUpDown_Size_B.Value = Properties.Settings.Default.A4_CoverLetter_FontSize_Body > 0
                ? Properties.Settings.Default.A4_CoverLetter_FontSize_Body : 10;
            colorVal = Properties.Settings.Default.A4_CoverLetter_Color_Body;
            button_Color_B.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Signature
            savedFontName = Properties.Settings.Default.A4_CoverLetter_FontName_Signature;
            comboBox_FontName_S.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Monotype Corsiva";
            numericUpDown_Size_S.Value = Properties.Settings.Default.A4_CoverLetter_FontSize_Signature > 0
                ? Properties.Settings.Default.A4_CoverLetter_FontSize_Signature : 20;
            colorVal = Properties.Settings.Default.A4_CoverLetter_Color_Signature;
            button_Color_S.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Icon color (with fallback to black)
            int iconColorVal = Properties.Settings.Default.A4_CoverLetter_IconColor;
            button_IconColor.BackColor = (iconColorVal == 0) ? Color.Black : Color.FromArgb(iconColorVal);

            // Match reset styling to hide "Color" text
            ...
            // Apply icons and font styling
            ApplyIconColor(button_IconColor.BackColor);
            ApplyFontChanges();

            string icon1Path = Properties.Settings.Default.A4_CoverLetter_Icon1Path;
            string icon2Path = Properties.Settings.Default.A4_CoverLetter_Icon2Path;
            string icon3Path = Properties.Settings.Default.A4_CoverLetter_Icon3Path;
            string icon4Path = Properties.Settings.Default.A4_CoverLetter_Icon4Path;
            ...
            pictureBox_Icon1.Visible = Properties.Settings.Default.A4_CoverLetter_Icon1Visible;
            pictureBox_Icon2.Visible = Properties.Settings.Default.A4_CoverLetter_Icon2Visible;
            pictureBox_Icon3.Visible = Properties.Settings.Default.A4_CoverLetter_Icon3Visible;
            pictureBox_Icon4.Visible = Properties.Settings.Default.A4_CoverLetter_Icon4Visible;
        }
        ...
        private void ApplyFontChanges()
        {
            ...
            if (comboBox_FontName_S.SelectedItem != null)
            {
                ...
                Font newFont = CreateFont(fontName, size);
                foreach (Label lbl in GetAllControls(panelA4).OfType<Label>().Where(x => x.Tag?.ToString() == "Signature"))
                {
                    lbl.Font = newFont;
                    lbl.ForeColor = color;
                }
        ...
        private void A4_CoverLetter_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (unsavedChanges)
                AutosaveUserSettings();
        }
