...
{
    public partial class USLetter_References: Form
    {
        ...
        // Store the original bounds of controls in panelUS.
        ...
        public USLetter_References(string[] userData)
        {
            // Disable auto scaling to prevent unexpected DPI changes.
            this.AutoScaleMode = AutoScaleMode.None;            

            // Set fixed size for US Letter format (8.5 x 11 inches at 96 DPI)
            this.ClientSize = new Size(816, 1056);

            // Minimum resizing limit for smaller screens
            this.MinimumSize = new Size(816, 768);

            // Add vertical scroll bar if form height is smaller than maximum size
            this.AutoScroll = true;
            this.AutoScrollMinSize = new Size(0, 950);

            InitializeComponent(); // Load user-customizable elements (fonts, icons, colors)
            ...
            this.Resize += US_References_Resize;
            this.Load += US_References_Resize;
            ...
            autosaveTimer.Start();
            this.FormClosing += US_References_FormClosing;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var f1 = new USLetter_Reference_Info();
            f1.Size = this.Size;
            f1.Show();
            this.Close();
        }

        private void US_References_Resize(object sender, EventArgs e)
        {
            panelUS.Size = new Size(fixedWidth, fixedHeight);
        ...
        // PRINTING METHOD (using panelUS only)
        ...
        private void AutosaveUserSettings()
        {
            ...
            Properties.Settings.Default.US_References_Name = label_Name.Text;
            Properties.Settings.Default.US_References_PositionTitle = label_PositionTitle.Text;
            Properties.Settings.Default.US_References_Phone = label_Phone.Text;
            Properties.Settings.Default.US_References_Email = label_Email.Text;
            Properties.Settings.Default.US_References_Location = label_Location.Text;
            Properties.Settings.Default.US_References_LinkedIn = label_LinkedIn.Text;

            // Save cover letter–specific settings.
            Properties.Settings.Default.US_Ref_RefName1 = lbl_Ref1_N.Text;
            Properties.Settings.Default.US_Ref_PositionT1 = lbl_Ref1_PT.Text;
            Properties.Settings.Default.US_Ref_Org1 = lbl_Ref1_Org.Text;
            Properties.Settings.Default.US_Ref_Phone1 = lbl_Ref1_Ph.Text;
            Properties.Settings.Default.US_Ref_Email1 = lbl_Ref1_Em.Text;
            Properties.Settings.Default.US_Ref_RefName2 = lbl_Ref2_N.Text;
            Properties.Settings.Default.US_Ref_PositionT2 = lbl_Ref2_PT.Text;
            Properties.Settings.Default.US_Ref_Org2 = lbl_Ref2_Org.Text;
            Properties.Settings.Default.US_Ref_Phone2 = lbl_Ref2_Ph.Text;
            Properties.Settings.Default.US_Ref_Email2 = lbl_Ref2_Em.Text;
            Properties.Settings.Default.US_Ref_RefName3 = lbl_Ref3_N.Text;
            Properties.Settings.Default.US_Ref_PositionT3 = lbl_Ref3_PT.Text;
            Properties.Settings.Default.US_Ref_Org3 = lbl_Ref3_Org.Text;
            Properties.Settings.Default.US_Ref_Phone3 = lbl_Ref3_Ph.Text;
            Properties.Settings.Default.US_Ref_Email3 = lbl_Ref3_Em.Text;
            Properties.Settings.Default.US_Ref_RefName4 = lbl_Ref4_N.Text;
            Properties.Settings.Default.US_Ref_PositionT4 = lbl_Ref4_PT.Text;
            Properties.Settings.Default.US_Ref_Org4 = lbl_Ref4_Org.Text;
            Properties.Settings.Default.US_Ref_Phone4 = lbl_Ref4_Ph.Text;
            Properties.Settings.Default.US_Ref_Email4 = lbl_Ref4_Em.Text;
            Properties.Settings.Default.US_Ref_RefName5 = lbl_Ref5_N.Text;
            Properties.Settings.Default.US_Ref_PositionT5 = lbl_Ref5_PT.Text;
            Properties.Settings.Default.US_Ref_Org5 = lbl_Ref5_Org.Text;
            Properties.Settings.Default.US_Ref_Phone5 = lbl_Ref5_Ph.Text;
            Properties.Settings.Default.US_Ref_Email5 = lbl_Ref5_Em.Text;

            // Save font settings.
            Properties.Settings.Default.US_References_FontName_Name = comboBox_FontName_Name.SelectedItem?.ToString() ?? "Microsoft Sans Serif";
            Properties.Settings.Default.US_References_FontSize_Name = (decimal)numericUpDown_Size_Name.Value;
            Properties.Settings.Default.US_References_Color_Name = button_Color_Name.BackColor.ToArgb();

            Properties.Settings.Default.US_References_FontName_PT = comboBox_FontName_PT.SelectedItem?.ToString() ?? "Microsoft Sans Serif";
            Properties.Settings.Default.US_References_FontSize_PT = (decimal)numericUpDown_Size_PT.Value;
            Properties.Settings.Default.US_References_Color_PT = button_Color_PT.BackColor.ToArgb();

            Properties.Settings.Default.US_References_FontName_Body = comboBox_FontName_B.SelectedItem?.ToString() ?? "Microsoft Sans Serif";
            Properties.Settings.Default.US_References_FontSize_Body = (decimal)numericUpDown_Size_B.Value;
            Properties.Settings.Default.US_References_Color_Body = button_Color_B.BackColor.ToArgb();

            Properties.Settings.Default.US_References_FontName_H = comboBox_FontName_H.SelectedItem?.ToString() ?? "Microsoft Sans Serif";
            Properties.Settings.Default.US_References_FontSize_H = (decimal)numericUpDown_Size_H.Value;
            Properties.Settings.Default.US_References_Color_H = button_Color_H.BackColor.ToArgb();

            // Save icon file paths and icon color.
            Properties.Settings.Default.US_References_Icon1Path = pictureBox_Icon1.Tag as string ?? "";
            Properties.Settings.Default.US_References_Icon2Path = pictureBox_Icon2.Tag as string ?? "";
            Properties.Settings.Default.US_References_Icon3Path = pictureBox_Icon3.Tag as string ?? "";
            Properties.Settings.Default.US_References_Icon4Path = pictureBox_Icon4.Tag as string ?? "";
            Properties.Settings.Default.US_References_IconColor = button_IconColor.BackColor.ToArgb();

            // Persist each icon’s Visible state:
            Properties.Settings.Default.US_References_Icon1Visible = pictureBox_Icon1.Visible;
            Properties.Settings.Default.US_References_Icon2Visible = pictureBox_Icon2.Visible;
            Properties.Settings.Default.US_References_Icon3Visible = pictureBox_Icon3.Visible;
            Properties.Settings.Default.US_References_Icon4Visible = pictureBox_Icon4.Visible;
        ...
        {
            label_Name.Text = Properties.Settings.Default.US_References_Name;
            label_PositionTitle.Text = Properties.Settings.Default.US_References_PositionTitle;
            label_Phone.Text = Properties.Settings.Default.US_References_Phone;
            label_Email.Text = Properties.Settings.Default.US_References_Email;
            label_Location.Text = Properties.Settings.Default.US_References_Location;
            label_LinkedIn.Text = Properties.Settings.Default.US_References_LinkedIn;
            lbl_Ref1_N.Text = Properties.Settings.Default.US_Ref_RefName1;
            lbl_Ref1_PT.Text = Properties.Settings.Default.US_Ref_PositionT1;
            lbl_Ref1_Org.Text = Properties.Settings.Default.US_Ref_Org1;
            lbl_Ref1_Ph.Text = Properties.Settings.Default.US_Ref_Phone1;
            lbl_Ref1_Em.Text = Properties.Settings.Default.US_Ref_Email1;
            lbl_Ref2_N.Text = Properties.Settings.Default.US_Ref_RefName2;
            lbl_Ref2_PT.Text = Properties.Settings.Default.US_Ref_PositionT2;
            lbl_Ref2_Org.Text = Properties.Settings.Default.US_Ref_Org2;
            lbl_Ref2_Ph.Text = Properties.Settings.Default.US_Ref_Phone2;
            lbl_Ref2_Em.Text = Properties.Settings.Default.US_Ref_Email2;
            lbl_Ref3_N.Text = Properties.Settings.Default.US_Ref_RefName3;
            lbl_Ref3_PT.Text = Properties.Settings.Default.US_Ref_PositionT3;
            lbl_Ref3_Org.Text = Properties.Settings.Default.US_Ref_Org3;
            lbl_Ref3_Ph.Text = Properties.Settings.Default.US_Ref_Phone3;
            lbl_Ref3_Em.Text = Properties.Settings.Default.US_Ref_Email3;
            lbl_Ref4_N.Text = Properties.Settings.Default.US_Ref_RefName4;
            lbl_Ref4_PT.Text = Properties.Settings.Default.US_Ref_PositionT4;
            lbl_Ref4_Org.Text = Properties.Settings.Default.US_Ref_Org4;
            lbl_Ref4_Ph.Text = Properties.Settings.Default.US_Ref_Phone4;
            lbl_Ref4_Em.Text = Properties.Settings.Default.US_Ref_Email4;
            lbl_Ref5_N.Text = Properties.Settings.Default.US_Ref_RefName5;
            lbl_Ref5_PT.Text = Properties.Settings.Default.US_Ref_PositionT5;
            lbl_Ref5_Org.Text = Properties.Settings.Default.US_Ref_Org5;
            lbl_Ref5_Ph.Text = Properties.Settings.Default.US_Ref_Phone5;
            lbl_Ref5_Em.Text = Properties.Settings.Default.US_Ref_Email5;

            // Name
            string savedFontName = Properties.Settings.Default.US_References_FontName_Name;
            comboBox_FontName_Name.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Microsoft Sans Serif";
            numericUpDown_Size_Name.Value = Properties.Settings.Default.US_References_FontSize_Name > 0
                ? Properties.Settings.Default.US_References_FontSize_Name : 25;
            int colorVal = Properties.Settings.Default.US_References_Color_Name;
            button_Color_Name.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Position Title
            savedFontName = Properties.Settings.Default.US_References_FontName_PT;
            comboBox_FontName_PT.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Microsoft Sans Serif";
            numericUpDown_Size_PT.Value = Properties.Settings.Default.US_References_FontSize_PT > 0
                ? Properties.Settings.Default.US_References_FontSize_PT : 12;
            colorVal = Properties.Settings.Default.US_References_Color_PT;
            button_Color_PT.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Body
            savedFontName = Properties.Settings.Default.US_References_FontName_Body;
            comboBox_FontName_B.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Microsoft Sans Serif";
            numericUpDown_Size_B.Value = Properties.Settings.Default.US_References_FontSize_Body > 0
                ? Properties.Settings.Default.US_References_FontSize_Body : 10;
            colorVal = Properties.Settings.Default.US_References_Color_Body;
            button_Color_B.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Headings
            savedFontName = Properties.Settings.Default.US_References_FontName_H;
            comboBox_FontName_H.SelectedItem = !string.IsNullOrEmpty(savedFontName)
                ? savedFontName : "Microsoft Sans Serif";
            numericUpDown_Size_H.Value = Properties.Settings.Default.US_References_FontSize_H > 0
                ? Properties.Settings.Default.US_References_FontSize_H : 12;
            colorVal = Properties.Settings.Default.US_References_Color_H;
            button_Color_H.BackColor = (colorVal == 0) ? Color.Black : Color.FromArgb(colorVal);

            // Icon Color
            int iconColorVal = Properties.Settings.Default.US_References_IconColor;
            button_IconColor.BackColor = (iconColorVal == 0) ? Color.Black : Color.FromArgb(iconColorVal);

            // Style the icon color button just like on reset
            ...
            // Apply the saved icon color to all icons.
            ApplyIconColor(button_IconColor.BackColor);
            ApplyFontChanges();

            string icon1Path = Properties.Settings.Default.US_References_Icon1Path;
            string icon2Path = Properties.Settings.Default.US_References_Icon2Path;
            string icon3Path = Properties.Settings.Default.US_References_Icon3Path;
            string icon4Path = Properties.Settings.Default.US_References_Icon4Path;
            ...
            pictureBox_Icon1.Visible = Properties.Settings.Default.US_References_Icon1Visible;
            pictureBox_Icon2.Visible = Properties.Settings.Default.US_References_Icon2Visible;
            pictureBox_Icon3.Visible = Properties.Settings.Default.US_References_Icon3Visible;
            pictureBox_Icon4.Visible = Properties.Settings.Default.US_References_Icon4Visible;
        }
        ...
        private void US_References_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (unsavedChanges)
                AutosaveUserSettings();
        }
